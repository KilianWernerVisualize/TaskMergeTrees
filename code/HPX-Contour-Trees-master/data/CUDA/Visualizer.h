...
public:
    ...
    void visualizePair(vtkIdType one, vtkIdType two)
    {
        ...
        actorext->GetProperty()->SetOpacity(1.0);

        boundary_actors.push_back(actorext);
    ...
    void visualizeBranch(vtkIdType one, vtkIdType two, bool trunk)
    {
